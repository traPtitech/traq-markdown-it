...
describe('highlight', () => {
  ...
  it.concurrent('can output without caption', () => {
  ...
  it.concurrent('can output with caption', () => {
  ...
  it.concurrent('can output with caption escaped', () => {
