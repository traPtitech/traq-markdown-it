...
describe('stamp', () => {
  ...
  {
    const expected1 = '<i class="emoji message-emoji " title=":one:" style="background-image: url(/api/v3/files/e97518db-ebb8-450f-9b4a-273234e68491);">:one:</i>'
    const expected2 = '<i class="emoji message-emoji " title=":two:" style="background-image: url(/api/v3/files/d7461966-e5d3-4c6d-9538-7c8605f45a1e);">:two:</i>'
  ...
  {
    const expected1 = '<i class="emoji message-emoji " title=":@one:" style="background-image: url(/api/v3/files/e97518db-ebb8-450f-9b4a-273234e68491);">:@one:</i>'
    const expected2 = '<i class="emoji message-emoji " title=":@longlonglonglonglonglonglonglonglonglonglonglong:" style="background-image: url(/api/v3/files/e97518db-ebb8-450f-9b4a-273234e68491);">:@longlonglonglonglonglonglonglonglonglonglonglong:</i>'
    const expected3 = '<i class="emoji message-emoji " title=":@Webhook#random-Va1ue:" style="background-image: url(/api/v3/files/e97518db-ebb8-450f-9b4a-273234e68491);">:@Webhook#random-Va1ue:</i>'
    ...
    it('can render user stamps', () => {
      const actual = md.render(':@one: :@longlonglonglonglonglonglonglonglonglonglonglong: :@Webhook#random-Va1ue:').trim()
  ...
  {
    const expected1 = '<i class="emoji message-emoji " title=":0xffffff:" style="background-color: #ffffff;">:0xffffff:</i>'
    const expected2 = '<i class="emoji message-emoji " title=":0xFFFFFF:" style="background-color: #FFFFFF;">:0xFFFFFF:</i>'
    const expected3 = '<i class="emoji message-emoji " title=":0xFFeeFF:" style="background-color: #FFeeFF;">:0xFFeeFF:</i>'
  ...
  {
    const expected1 = '<i class="emoji message-emoji " title=":hsl(0, 0%, 0%):" style="background-color: hsl(0, 0%, 0%);">:hsl(0, 0%, 0%):</i>'
    ...
    it('wont render invalid stamp (2)', () => {
      const actual = md.render(':invalidinvalidinvalidinvalidinvalid(invalidinvalid):').trim()
  ...
  {
    const expected1 = '<i class="emoji message-emoji ex-large" title=":one:" style="background-image: url(/api/v3/files/e97518db-ebb8-450f-9b4a-273234e68491);">:one:</i>'
    const expected2 = '<span class="emoji-effect wiggle"><i class="emoji message-emoji " title=":one:" style="background-image: url(/api/v3/files/e97518db-ebb8-450f-9b4a-273234e68491);">:one:</i></span>'
    ...
    it('wont render stamp with many animation effect', () => {
      const actual = md.render(':one.wiggle.wiggle.wiggle.wiggle.wiggle.wiggle:').trim()
      const expected = `<p>${expected4}</p>`
      expect(actual).toBe(expected)
    })
  }
